...
sub printGeography {
    ...
    my $content = "";
    $content
        .= "This $city->{'arable_description'} $city->{'size'} is $city->{'density_description'} populated (".format_number($city->{'population_density'})." people/sq km), covers $city->{'area'} square kilometers, and roughly has a diameter of $city->{'diameter'} meters. \n";
