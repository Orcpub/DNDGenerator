...
subtest 'test create' => sub {
    ...
    $climate = ClimateGenerator::create( );
...
subtest 'test calculate_wind' => sub {
    ...
    $climate
        = ClimateGenerator::create( { 'seed' => 1, 'wind_roll' => '100', 'wind_variation_roll' => '100' } );
    ...
    $climate = ClimateGenerator::create( { 'seed' => 1, 'wind' => 'some', 'wind_variation' => 'awful' } );
    $climate = ClimateGenerator::calculate_wind($climate);
...
subtest 'test calculate_temp' => sub {
    ...
    $climate = ClimateGenerator::create( { 'seed' => 1, 'stats'=>{'temperature' => '100', 'precipitation'=>'50'}, 'temp_variation_roll' => '100' } );
    ...
    $climate = ClimateGenerator::create( { 'seed' => 1, 'stats'=>{'temperature' => '100'}, 'temp_variation_roll' => '100', 'biomekey'=>'CS', 'name'=>'foo', 'description'=>'bar', 'color'=>'derp' } );
...
subtest 'test calculate_temp' => sub {
    ...
    $climate
        = ClimateGenerator::create( { 'seed' => 1, 'stats'=>{'temperature' => '100'}, 'temp_variation_roll' => '100' } );
    ...
    $climate = ClimateGenerator::create( { 'seed' => 1, 'temp' => 'some', 'temp_variation' => 'awful' } );
    $climate = ClimateGenerator::calculate_temp($climate);
...
subtest 'test calculate_precip' => sub {
    ...
    $climate = ClimateGenerator::create( { 'seed' => 1, 'precip' => 'some', 'precip_variation' => 'awful' } );
    $climate = ClimateGenerator::calculate_precip($climate);
